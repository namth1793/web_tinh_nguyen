...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'flex items-center flex-shrink-0 h-14',
      ...
      <nav className="flex-1 py-3 overflow-y-auto overflow-x-hidden"
        ...
        <ul className={cn('space-y-0.5', sidebarCollapsed ? 'px-2' : 'px-3')}>
          {navItems.map((item) => {
            ...
            // Exact match — plus: quiz sub-pages (e.g. /quiz/123) highlight "Thi theo chủ đề"
            const isActive =
              pathname === item.href ||
              ...
              <li key={item.href}>
                <Link href={item.href}>
                  <div
                    ...
                    onMouseEnter={(e) => {
                      if (!isActive) e.currentTarget.style.background = 'rgba(212,160,23,0.1)';
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <Icon
                      ...
                      style={{ color: isActive ? '#fff' : 'rgba(212,160,23,0.65)' }}
                    />
      ...
      <div className={cn('flex-shrink-0 py-3', sidebarCollapsed ? 'px-2 flex flex-col items-center gap-3' : 'px-3 py-4')}>
            ...
            >
              <div className="rounded-xl p-3" style={{ background: 'rgba(212,160,23,0.08)', border: '1px solid rgba(212,160,23,0.12)' }}>
                <p className="text-[9px] leading-relaxed italic text-center"
                  ...
                  "Hãy tự mình thắp đuốc lên mà đi,<br/>hãy lấy Chánh pháp làm ngọn đuốc."
                </p>
                <p className="text-[8px] text-center mt-1" style={{ color: 'rgba(212,160,23,0.4)' }}>— Đức Phật Thích Ca</p>
              </div>
              {/* Streak */}
              <div className="flex items-center gap-2 px-1 mt-2.5">
                ...
                <span className="text-xs whitespace-nowrap" style={{ color: 'rgba(253,246,227,0.5)' }}>
                  Streak: <span className="font-bold text-yellow-400">7 ngày</span>
                </span>
              </div>
            </motion.div>
          )}
        ...
        {sidebarCollapsed && (
          <div className="flex flex-col items-center gap-0.5 group relative cursor-default" title="Streak: 7 ngày">
        ...
        <button
          ...
          className={cn(
            ...
            sidebarCollapsed ? 'w-10 h-10' : 'w-full h-9 gap-2',
          )}
          style={{
        ...
        >
          {sidebarCollapsed
            ...
            : <><ChevronLeft size={14} /><span className="text-xs font-medium">Thu gọn</span></>
          }
        </button>
      </div>
      ...
      {sidebarOpen && (
        <>
          ...
          <motion.aside
            ...
            style={{
              background: 'linear-gradient(180deg, #2A1505 0%, #160C02 100%)',
              borderRight: '1px solid rgba(212,160,23,0.2)',
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 h-14 flex-shrink-0"
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-bold text-xs tracking-widest" style={{ color: '#F5C842', fontFamily: 'Cinzel, serif' }}>Phật Pháp Test</p>
                  <p className="text-[9px]" style={{ color: 'rgba(212,160,23,0.5)' }}>Học Phật · An Lạc</p>
                </div>
              </div>
                    ...
                    <li key={item.href}>
                      <Link href={item.href} onClick={() => setSidebarOpen(false)}>
                        <div
                          ...
                          style={isActive
                            ? { background: 'linear-gradient(135deg, rgba(212,160,23,0.9), rgba(184,134,11,0.9))', boxShadow: '0 2px 10px rgba(184,134,11,0.4)' }
                            : {}}
